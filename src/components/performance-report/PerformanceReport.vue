<template>
  <form @submit.prevent class="grid gap-y-5">
  ...
  <div class="grid gap-y-10" v-if="showReport && !isLoading">
    ...
    <!-- <BaseAccordion :items="filteredMetrics">
...
import BaseAccordion from "@base/accordion/BaseAccordion.vue";
...
const pagespeedReportAudits = computed(() => {
  return pageSpeedReport.value.lighthouseResult?.audits;
});
